...
angular.module('sophieYoungPortfolioApp')
  .controller('MainCtrl', function ($scope) {
    ...
    {image:'../images/NEW-PORTFOLIO-8.jpg', link: 'https://www.youtube.com/watch?v=VMuXQTKxgVc&feature=youtu.be', text: 'View Here'},
    {image:'../images/NEW-PORTFOLIO-9.jpg', link: 'http://www.youtube.com/watch?v=tQbmc2jMXDM', text: 'View Here'},
